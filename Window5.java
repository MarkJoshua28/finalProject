...
public class Window5 {
    ...
    public Window5() {
       ...
       // Create the Back Button with Image Icon
       ImageIcon backIcon = new ImageIcon("src/img/backbutton.png");
       ...
       guestHeadPanel.add(backButton);
        ...
        // Create Button Icon
        ImageIcon icon = new ImageIcon("src/img/searchIcon.png");
        ...
        cenPanel.add(createCityPanel("src/img/manila.png"));
        cenPanel.add(createCityPanel("src/img/quezon_city.png"));
        cenPanel.add(createCityPanel("src/img/mandaluyong.png"));
        cenPanel.add(createCityPanel("src/img/pasay.png"));
        cenPanel.add(createCityPanel("src/img/taguig.png"));
        cenPanel.add(createCityPanel("src/img/paranaque.png"));
        ...
        sideSticker = new ImageIcon("src/img/sidesticker.png");
